...
<div className="max-w-5xl max-md:max-w-xl mx-auto font-[sans-serif] my-4 pt-20">
      <div className="text-center max-w-2xl mx-auto">
        <h2 className="text-gray-800 text-3xl font-extrabold text-center mb-6">Our Exclusive Features</h2>
