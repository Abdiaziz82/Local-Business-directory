...
const About = () => {
  return (
    <div className="bg-gradient-to-r from-blue-50 to-white py-16 px-4 sm:px-6 lg:px-8 spartan">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-5xl font-extrabold text-gray-900 sm:text-6xl tracking-tight leading-tight pt-10">
          About BizHub
        </h2>
      ...
      <div className="mt-16 grid gap-12 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
        {/* Our Mission */}
